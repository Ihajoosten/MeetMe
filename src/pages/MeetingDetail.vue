        ...
        <div class="container">
          ...
          <article class="media v-center">
            ...
            <div class="media-content">
              <div class="content">
                <p>
                  Created by <strong>{{meetingCreator.name}}</strong>
                </p>
              </div>
            </div>
          </article>
            ...
            <aside class="is-medium menu">
              <div class="meeting-side-box">
                <div class="meeting-side-box-date m-b-sm">
                  <p><b>Date</b></p>
                  <p>{{meeting.startDate | formatDate}}</p>
                </div>
                <div class="meeting-side-box-date m-b-sm">
                  <p><b>Time</b></p>
                  <span>{{meeting.timeFrom}}</span> - <span>{{meeting.timeTo}}</span>
                </div>
              ...
              <div class="meeting-side-box-map">
                <img src="https://cnet2.cbsistatic.com/img/H_zPLL8-QTZOLxJvgHQ1Jkz0EgY=/830x467/2013/07/10/f0bcef02-67c2-11e3-a665-14feb5ca9861/maps_routemap.png" class="venueMap-mapImg span--100" alt="Location image of meeting venue">
              </div>
              <!-- Threads Start -->
              <p class="menu-label">
                Threads
